...
class LPIPS(nn.Module):
    def __init__(self, dist_mode='squared_l2'):
        super().__init__()
    ...
    def _load_lpips_weights(self):
        ...
        lpips_name = 'lpips_weights.pth' if self.dist_mode == "l2" else "lpips_weights.ckpt"
    ...
    def _dist_fun(self, conv, fmap):
        if self.dist_mode == "l2":
            return torch.mean(conv(torch.sqrt(fmap**2)))
        elif self.dist_mode == "squared_l2":
